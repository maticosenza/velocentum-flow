...
// 12 small triangular shards in --gradient-brand, standing in for facets of
// the Crystal V that haven't found their place yet. Scattered across the
// scene for Dolor 1; the same visual language regroups into three clusters
// for Dolor 2 (see DOLOR2_CLUSTERS below).
const DOLOR1_FRAGMENTS: FragmentDef[] = [
  { top: "10%", left: "15%", size: 22, rotate: 15, opacity: 0.6, driftX: 10, driftY: -8 },
  { top: "20%", left: "55%", size: 30, rotate: -20, opacity: 0.4, driftX: -12, driftY: 6 },
  { top: "8%", left: "75%", size: 18, rotate: 40, opacity: 0.7, driftX: 8, driftY: 10 },
  { top: "35%", left: "8%", size: 26, rotate: -10, opacity: 0.5, driftX: -10, driftY: -6 },
  { top: "42%", left: "38%", size: 34, rotate: 25, opacity: 0.8, driftX: 12, driftY: 4 },
  { top: "30%", left: "68%", size: 20, rotate: -35, opacity: 0.35, driftX: -6, driftY: 12 },
  { top: "55%", left: "20%", size: 24, rotate: 50, opacity: 0.55, driftX: 9, driftY: -10 },
  { top: "60%", left: "50%", size: 16, rotate: -5, opacity: 0.3, driftX: -8, driftY: 8 },
  { top: "50%", left: "80%", size: 28, rotate: 30, opacity: 0.65, driftX: 6, driftY: -12 },
  { top: "75%", left: "12%", size: 20, rotate: -25, opacity: 0.45, driftX: -10, driftY: 5 },
  { top: "78%", left: "45%", size: 32, rotate: 10, opacity: 0.75, driftX: 12, driftY: -8 },
  { top: "70%", left: "70%", size: 18, rotate: -45, opacity: 0.5, driftX: -9, driftY: 9 },
];
...
function Dolor1() {
  ...
  return (
    <section className="dolor-section section-v bg-ink-deep">
      <div className="container-v grid grid-cols-1 items-center gap-12 md:grid-cols-2">
...
const DOLOR2_CLUSTERS: ClusterDef[] = [
  {
    ...
    left: "26%",
    fragments: [
      { top: "-8%", left: "-6%", size: 24, rotate: 12, opacity: 0.6, driftX: 0, driftY: 0 },
      { top: "6%", left: "8%", size: 20, rotate: -18, opacity: 0.45, driftX: 0, driftY: 0 },
      { top: "10%", left: "-10%", size: 28, rotate: 30, opacity: 0.7, driftX: 0, driftY: 0 },
      { top: "-4%", left: "12%", size: 18, rotate: -6, opacity: 0.4, driftX: 0, driftY: 0 },
    ],
  },
  {
    top: "24%",
    left: "72%",
    fragments: [
      { top: "-6%", left: "4%", size: 26, rotate: -22, opacity: 0.55, driftX: 0, driftY: 0 },
      { top: "8%", left: "-8%", size: 22, rotate: 16, opacity: 0.65, driftX: 0, driftY: 0 },
      { top: "-10%", left: "-4%", size: 18, rotate: 40, opacity: 0.35, driftX: 0, driftY: 0 },
      { top: "10%", left: "10%", size: 20, rotate: -30, opacity: 0.5, driftX: 0, driftY: 0 },
    ],
  },
  {
    top: "72%",
    left: "42%",
    fragments: [
      { top: "-8%", left: "0%", size: 30, rotate: 8, opacity: 0.75, driftX: 0, driftY: 0 },
      { top: "6%", left: "10%", size: 20, rotate: -14, opacity: 0.4, driftX: 0, driftY: 0 },
      { top: "8%", left: "-10%", size: 24, rotate: 24, opacity: 0.6, driftX: 0, driftY: 0 },
      { top: "-4%", left: "-14%", size: 16, rotate: -40, opacity: 0.3, driftX: 0, driftY: 0 },
    ],
  },
];

// A handful of connecting lines between fragments in different clusters —
// "algunos pares", not a full mesh. Coordinates are % of the scene box,
// matching each cluster's anchor above.
const DOLOR2_LINES = [
  { x1: 26, y1: 28, x2: 72, y2: 24 },
  { x1: 26, y1: 28, x2: 42, y2: 72 },
...
function Dolor2() {
  ...
  return (
    <section ref={sectionRef} className="dolor-section section-v bg-ink-deep">
      <div className="container-v grid grid-cols-1 items-center gap-12 md:grid-cols-2">
        <div className="order-2 md:order-1">
